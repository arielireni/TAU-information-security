...
def get_crash_arg() -> bytes:
    ...
    password = "AAAAABBBBBCCCCCDDDDDEEEEEFFFFFGGGGGHHHHHIIIIIJJJJJ"+ "a"*36 + "AAAAABBBBBCCCCCDDDDDEEEEEFFFFFGGGGGHHHHHIIIIIJJJJJKKKKKLLLLL"
    bytes_password = password.encode('latin-1')
